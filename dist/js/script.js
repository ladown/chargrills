...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var secondDots = document.querySelectorAll(".othprice__circles span");
  var secondSlides = document.querySelectorAll(".othprice__item");
  var thirdDots = document.querySelectorAll(".popular__circles span");
  var thirdSlides = document.querySelectorAll(".popular__item");

  function slider(sliderNum, dotsSelector, slidesSelector) {
    var sliderIndex = sliderNum;
    ...
    function showSlides(n) {
      ...
      slidesSelector.forEach(function (item) {
      ...
      dotsSelector.forEach(function (item, index) {
    ...
    if (document.body.clientWidth < 768) {
      ...
      dotsSelector.forEach(function (item) {
